...
class NeuroDecoder(nn.Module):
    def __init__(self,inputs_dim,DSL):
        ...
        self.projection_operator = FCBlock(512,3,inputs_dim,DSL.op_dim)
        self.repeater = FCBlock(512,3,DSL.op_dim + inputs_dim,inputs_dim)
        self.DSL = DSL
        self.working_loss = 0
        self.counter = 0
    ...
    def operator_pdf(self,key,Type):
        ...
        pdf = torch.sigmoid( (torch.cosine_similarity(key_proj,operator_features)-0.2) /0.1)
